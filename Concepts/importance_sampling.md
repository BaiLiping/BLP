1. importance sampling bring enormous gains, making an otherwise infeasible problem amenable to Monte Carlo. It is one of the hardest variance reduction method to use well.
